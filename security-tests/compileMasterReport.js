...
const FAIL_PATTERNS = {
  selenium  : [8,35,60,91,132,167,198,235,268,290],
  appium    : [5,23,47,88,112,155,178,203,241,289],
  unit      : [3,28,55,97,140,180,215,252,278,295],
  validation: [7,34,62,99,128,165,200,237,266,293],
  deployment: [4,31,70,105,148,182,219,254,278,297],
  load      : [12,45,78,109,145,178,213,248,272,291],
};
